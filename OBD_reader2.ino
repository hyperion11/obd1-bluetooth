...
//Расход в час
 ...
 // Лямбда
       ...
       if (OBD_OXSENS) {if (inputString.substring(0, 4) == "0114")  Serial.print("41 14 "), Serial.print(OBD_OXSENS, HEX), Serial.println(" 00");}
